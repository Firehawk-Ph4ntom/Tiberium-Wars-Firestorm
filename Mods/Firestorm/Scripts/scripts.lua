...
function onBuildingPowerOutage(self)
	...
	ObjectHideSubObjectPermanently( self, "PLANE04", true )
	ObjectHideSubObjectPermanently( self, "PLANE07", true )
	ObjectHideSubObjectPermanently( self, "HEADLIGHTS", true )
	...
	ObjectHideSubObjectPermanently( self, "LIGHTR01", true )
	ObjectHideSubObjectPermanently( self, "LIGHTR02", true )
	ObjectHideSubObjectPermanently( self, "LIGHTR03", true )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS01", true )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS02", true )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS03", true )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS04", true )
	...
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS02", true )
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS03", true )
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS04", true )
	...
	ObjectHideSubObjectPermanently( self, "FX_GLOW", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS01", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS02", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS03", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS04", true )
	ObjectHideSubObjectPermanently( self, "FXGLOWS05", true )
	...
	ObjectHideSubObjectPermanently( self, "FX_RAGEGLOW", true )
...
function onBuildingPowerRestored(self)
	...
	ObjectHideSubObjectPermanently( self, "PLANE04", false )
	ObjectHideSubObjectPermanently( self, "PLANE07", false )
	ObjectHideSubObjectPermanently( self, "HEADLIGHTS", false )
	...
	ObjectHideSubObjectPermanently( self, "LIGHTR01", false )
	ObjectHideSubObjectPermanently( self, "LIGHTR02", false )
	ObjectHideSubObjectPermanently( self, "LIGHTR03", false )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS01", false )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS02", false )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS03", false )
	ObjectHideSubObjectPermanently( self, "LANDINGLIGHTS04", false )
	...
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS02", false )
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS03", false )
	ObjectHideSubObjectPermanently( self, "FX_LIGHTS04", false )
	ObjectHideSubObjectPermanently( self, "FLASHINGLIGHTL", false )
	ObjectHideSubObjectPermanently( self, "FLASHINGLIGHTR", false )
	ObjectHideSubObjectPermanently( self, "GLOWS", false )
	ObjectHideSubObjectPermanently( self, "FX_GLOW", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS01", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS02", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS03", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS04", false )
	ObjectHideSubObjectPermanently( self, "FXGLOWS05", false )
	...
	ObjectHideSubObjectPermanently( self, "FX_RAGEGLOW", false )
